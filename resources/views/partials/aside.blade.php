<aside class="sidebar-wrapper" data-simplebar="true">
    <div class="sidebar-header">
      ...
      <div class="logo-name flex-grow-1">
        <h5 class="mb-0">Can Assistance</h5>
      </div>
    ...
    <div class="sidebar-nav">
        ...
        <ul class="metismenu" id="sidenav">
          ...
          <li>
            ...
            <ul>
              <li><a href="widgets-data.html"><i class="material-icons-outlined">arrow_right</i>Paket Satın Al</a>
              </li>
              <li><a href="widgets-static.html"><i class="material-icons-outlined">arrow_right</i>Paket Listele</a>
              </li>
            </ul>
          </li>
          <li>
            <a class="has-arrow" href="javascript:;">
              ...
              <div class="menu-title">Sözleşmeler</div>
            </a>
            <ul>
              <li><a href="app-emailbox.html"><i class="material-icons-outlined">arrow_right</i>Sözleşme Ekle</a>
              </li>
              <li><a href="app-emailread.html"><i class="material-icons-outlined">arrow_right</i>Sözleşme Listele</a>
              </li>
            </ul>
          </li>
          <li class="menu-label">Komisyon</li>
          <li>
            <a href="cards.html">
              <div class="parent-icon"><i class="material-icons-outlined">inventory_2</i>
              </div>
              <div class="menu-title">Komisyon Düzenle</div>
            </a>
          </li>
          ...
          <li>
            <a href="javascript:;" class="has-arrow">
              ...
              <div class="menu-title">Bayiler</div>
            </a>
            <ul>
          ...
          <li class="menu-label">Araç Listesi</li>
          <li>
            <a class="has-arrow" href="javascript:;">
